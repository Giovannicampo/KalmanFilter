...
int main()
{
    ...
    // std::map<int, double> hist_measure_0_75{};
    // std::map<int, double> hist_measure_1_5{};
    // std::map<int, double> hist_measure_3_0{};
    // std::map<int, double> hist_measure_4_5{};
    ...
    // for(unsigned short i=0; i<DIM; i++)
    // {
    //     fscanf(fp, "%lf", &temp_value);
    //     ++hist_measure_0_75[(double)temp_value];
    // }
    ...
    // {
    //     fscanf(fp, "%lf", &temp_value);
    //     ++hist_measure_1_5[(double)temp_value];
    // }
    ...
    // {
    //     fscanf(fp, "%lf", &temp_value);
    //     ++hist_measure_3_0[(double)temp_value];
    // }
    ...
    // {
    //     fscanf(fp, "%lf", &temp_value);
    //     ++hist_measure_4_5[(double)temp_value];
    // }

    // fclose(fp);

    FILE* fp = fopen("tof_0_2m.txt", "r");
